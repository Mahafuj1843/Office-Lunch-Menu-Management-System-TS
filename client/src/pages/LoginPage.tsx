...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        if (IsEmail(user.email)) {
            ...
            const result: boolean = await LoginRequest(user)

            setTimeout(() => {
                if (result) {
                    let userDetailsString: any = localStorage.getItem("UserDetails");
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-start">
                                        ...
                                        <div className="ml-1 md:ml-3 text-sm">
                                            <label className="text-xs md:text-sm text-gray-500 ">Remember me</label>
                                        </div>
                                    </div>
